      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-20">
          {modules.map((item, idx) => (
            <div key={idx} className="bg-slate-950/80 border border-accent-500/20 p-6 rounded-xl hover:border-accent-500/60 hover:shadow-[inset_0_0_20px_rgba(245,158,11,0.1)] transition-all duration-300 group backdrop-blur-md flex flex-col h-full">
              <div className="flex items-center mb-4">
                <div className="p-2 rounded bg-accent-500/10 text-accent-400 mr-3 group-hover:bg-accent-500 group-hover:text-white transition-colors shrink-0">
              ...
              <p className="text-sm text-slate-400 border-l border-accent-500/10 pl-3 group-hover:border-accent-500/50 transition-colors flex-grow">
                {item.desc}
              </p>
            </div>
          ))}

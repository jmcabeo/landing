        ...
        <div className="grid md:grid-cols-5 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="relative flex flex-col items-center text-center group">
              ...
              {/* Circle Number */}
              <div className="relative w-20 h-20 mb-8 transition-transform duration-500 group-hover:scale-110 group-active:scale-110 shrink-0">
                {/* Outer Ring */}
                <div className="absolute inset-0 rounded-full border border-accent-500/30 group-hover:border-accent-500 group-active:border-accent-500 group-hover:shadow-[0_0_20px_rgba(245,158,11,0.4)] group-active:shadow-[0_0_20px_rgba(245,158,11,0.4)] transition-all bg-slate-950"></div>
                {/* Inner text */}
              ...
              <h3 className="text-lg font-bold text-white mb-3 group-hover:text-accent-300 group-active:text-accent-300 transition-colors leading-tight h-12 flex items-center justify-center">
                {step.title}
              </h3>
